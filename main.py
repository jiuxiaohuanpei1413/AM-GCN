...
''' Fixed in general '''
parser.add_argument('--data_root_dir', default='F:\code\experiment\data', type=str, help='save path')
parser.add_argument('--image-size', '-i', default=448, type=int)
parser.add_argument('--epochs', default=200, type=int)
parser.add_argument('--epoch_step', default=[ 30,   50,  100], type=int, nargs='+', help='number of epochs to change learning rate[30, 50, 100]')
...
''' Val or Tese setting '''
parser.add_argument('-e', '--evaluate', dest='evaluate', action='store_false', help='evaluate model on validation set')
parser.add_argument('--resume', default='{THE-TEST-MODEL}', type=str, metavar='PATH', help='path to latest checkpoint (default: none)')
...
def main(args):
    ...
    is_train = True if args.evaluate else False
    ...
    trainer = Trainer(model, criterion, criterion1, train_loader, val_loader, args)
