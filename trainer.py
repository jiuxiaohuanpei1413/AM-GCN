...
class Trainer(object):
    def __init__(self, model, criterion, criterion1, train_loader, val_loader, args):
        self.model = model
    ...
    def initialization(self, is_train=False):
        ...
        if torch.cuda.is_available():
            ...
            self.model = torch.nn.DataParallel(self.model, device_ids = self.args.device_ids).cuda()
    ...
    def on_forward(self, inputs, targets, is_train, inp):
    ...
    def run_iteration(self, data_loader, is_train=True):
        ...
        for i, data in enumerate(data_loader):
            ...
            outputs = self.on_forward(inputs, targets, is_train=is_train, inp=inp)
